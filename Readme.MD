...
Demo Assets - not production ready - and delivered "as-is" allow you to display some real time KPIs in Webex Contact Center Agent Desltop header such as : 
...
- download the given javascript asset.
